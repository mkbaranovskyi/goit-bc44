...
const { createHash, createHttpException, createJWT, sendEmailVerificationLetter } = require('../../servcies')
...
const signUp = async (req, res, next) => {
  ...
  const newUser = await UserModel.create({ email, passwordHash, emailVerificationToken })
